...
.history-grid .grid-row span.history-kind, .history-grid .grid-row span:nth-child(5).history-kind { background: #fff3d6 !important; color: #9a5b00 !important; }
.history-grid .grid-row .history-kind.available, .history-grid .grid-row span.history-kind.available, .history-grid .grid-row span:nth-child(5).history-kind.available { background: #dff7ea !important; color: #0f7a45 !important; }
